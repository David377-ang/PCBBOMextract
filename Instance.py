...
BOM_PLM_output = "BOM_PLM_output.txt"
...
def main():
    ...
    create_or_replace_file(os.path.join(executable_dir, BOM_PLM_output))
    ...
    Output_list = extract_location_texts_PLM(filename)

    write_list_to_file(Output_list, BOM_PLM_output)    
